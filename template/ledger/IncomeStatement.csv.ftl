...
<#macro showClass classInfo depth>
    ...
    <#t><#if (timePeriodIdList?size > 1)><@csvValue ec.l10n.format(classInfo.postedNoClosingByTimePeriod['ALL']!0, currencyFormat)/>,</#if>
    <#list timePeriodIdList as timePeriodId>
        <#t><@csvValue ec.l10n.format(classInfo.postedNoClosingByTimePeriod[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
    </#list>
    <#t><#if showDiff><@csvValue ec.l10n.format((classInfo.postedNoClosingByTimePeriod[timePeriodIdList[1]]!0) - (classInfo.postedNoClosingByTimePeriod[timePeriodIdList[0]]!0), currencyFormat)/></#if>
    <#t>${"\n"}
    <#list classInfo.glAccountInfoList! as glAccountInfo><#if showDetail>
        ...
        <#t><#if (timePeriodIdList?size > 1)><@csvValue ec.l10n.format(glAccountInfo.postedNoClosingByTimePeriod['ALL']!0, currencyFormat)/>,</#if>
        <#list timePeriodIdList as timePeriodId>
            <#t><@csvValue ec.l10n.format(glAccountInfo.postedNoClosingByTimePeriod[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
        </#list>
        <#t><#if showDiff><@csvValue ec.l10n.format((glAccountInfo.postedNoClosingByTimePeriod[timePeriodIdList[1]]!0) - (glAccountInfo.postedNoClosingByTimePeriod[timePeriodIdList[0]]!0), currencyFormat)/></#if>
        <#t>${"\n"}
    </#if></#list>
    ...
    <#if classInfo.childClassInfoList?has_content>
        ...
        <#t><#if (timePeriodIdList?size > 1)><@csvValue ec.l10n.format(classInfo.totalPostedNoClosingByTimePeriod['ALL']!0, currencyFormat)/>,</#if>
        <#list timePeriodIdList as timePeriodId>
            <#t><@csvValue ec.l10n.format(classInfo.totalPostedNoClosingByTimePeriod[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
        </#list>
        <#t><#if showDiff><@csvValue ec.l10n.format((classInfo.totalPostedNoClosingByTimePeriod[timePeriodIdList[1]]!0) - (classInfo.totalPostedNoClosingByTimePeriod[timePeriodIdList[0]]!0), currencyFormat)/></#if>
        <#t>${"\n"}
    </#if>
</#macro>
...
<#list timePeriodIdList as timePeriodId>
    <#t><@csvValue ec.l10n.format((classInfoById.REVENUE.totalPostedNoClosingByTimePeriod[timePeriodId]!0) + (classInfoById.CONTRA_REVENUE.totalPostedNoClosingByTimePeriod[timePeriodId]!0), currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
</#list>
...
<#list timePeriodIdList as timePeriodId>
    <#t><@csvValue ec.l10n.format(grossProfitOnSalesMap[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
</#list>
...
<#list timePeriodIdList as timePeriodId>
    <#t><@csvValue ec.l10n.format(netOperatingIncomeMap[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
</#list>
...
<#list timePeriodIdList as timePeriodId>
    <#t><@csvValue ec.l10n.format(netNonOperatingIncomeMap[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
</#list>
...
<#list timePeriodIdList as timePeriodId>
    <#t><@csvValue ec.l10n.format(netIncomeMap[timePeriodId]!0, currencyFormat)/><#if showDiff || timePeriodId_has_next>,</#if>
</#list>
